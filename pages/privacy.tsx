  ...
  return (
    <>
      <Head>
        ...
        ></link>
        <title>Supplier - Privacy policy</title>
      </Head>
      <InfoWrapper>
        <SmallLogoContainer>
          <MainLogo />
        ...
        <InfoCard>
          <InfoExplanation>
            Your privacy is important to us. It is Supplier Patryk
            Heljasiński&apos;s policy to respect your privacy and comply with
            ...
            https://www.supplierbots.io, and other sites we own and operate.
            <br />
            ...
            site.
            <br />
            This policy is effective as of 11 May 2021. Last updated: 11 May
            2021
          </InfoExplanation>
          ...
          <InfoTitle>Collection and Use of Information</InfoTitle>
          <InfoExplanation>
            ...
            applications, and associated social media platforms <br />
            ...
            third parties that we consider may be of interest to you <br />
            - for technical assessment, including to operate and improve our
            app, associated applications, and associated social media platforms
            <br />
          ...
          <InfoTitle>Security of Your Personal Information</InfoTitle>
          <InfoExplanation>
            ...
            access, disclosure, copying, use or modification. Although we will
            do our best to protect the personal information you provide to us,
            we advise that no method of electronic transmission or storage is
            100% secure and no one can guarantee absolute data security. You are
          ...
          <InfoTitle>How Long We Keep Your Personal Information</InfoTitle>
          <InfoExplanation>
            ...
            removing all details that identify you. However, if necessary, we
            may retain your personal information for our compliance with a
          ...
          <InfoHeading>Children’s Privacy</InfoHeading>
          <InfoExplanation>
          ...
          <InfoExplanation>
            ...
            have provided to you courts, tribunals, regulatory authorities, and
            law enforcement officers, as required by law, in connection with any
            ...
            in providing information, products, services, or direct marketing to
          ...
          <InfoExplanation>
            ...
            inaccurate, incomplete, misleading, or out of date. <br />
            ...
            with a different level or quality of goods or services. <br />
            Notification of data breaches: We will comply with laws applicable
            to us in respect of any data breach. <br />
            ...
            in relation to your complaint. <br />
          ...
          <InfoHeading>Use of Cookies</InfoHeading>
          <InfoExplanation>
          ...
          <InfoHeading>Business Transfers</InfoHeading>
          <InfoExplanation>
          ...
          <InfoHeading>Limits of Our Policy</InfoHeading>
          <InfoExplanation>
          ...
          <InfoHeading>Changes to This Policy</InfoHeading>
          <InfoExplanation>
            ...
            which you are accessing this privacy policy. If required by law, we
            will get your permission or give you the opportunity to opt in to or
            opt out of, as applicable, any new uses of your personal
            information.
          </InfoExplanation>
          <InfoHeading>
          ...
          <InfoTitle>Data Controller / Data Processor</InfoTitle>
          <InfoExplanation>
            ...
            organizations (known as “data processors”). We, Supplier Patryk
            Heljasiński are a Data Controller with respect to the personal
          ...
          <InfoExplanation>
            ...
            specific purpose. Our lawful bases depend on the services you use
            and how you use them. This means we only collect and use your
            information on the following grounds: <br />
            - Consent From You: Where you give us consent to collect and use
            your personal information for a specific purpose. You may withdraw
            your consent at any time using the facilities we provide; however
            this will not affect any use of your information that has already
            taken place. When you contact us, you may consent to your name and
            email address being used so we can respond to your enquiry. While
            you may request that we delete your contact details at any time, we
            cannot recall any email we have already sent. If you have any
            ...
            <br />
            - Performance of a Contract or Transaction: Where you have entered
            into a contract or transaction with us, or in order to take
            preparatory steps prior to our entering into a contract or
            transaction with you. For example, if you contact us with an
            enquiry, we may require personal information such as your name and
            contact details in order to respond.
            <br />
            - Our Legitimate Interests: Where we assess it is necessary for our
            legitimate interests, such as for us to provide, operate, improve
            and communicate our services. We consider our legitimate interests
            to include research and development, understanding our audience,
            marketing and promoting our services, measures taken to operate our
            services efficiently, marketing analysis, and measures taken to
            protect our legal rights and interests.
            <br />
            - Compliance with: Law In some cases, we may have a legal obligation
            to use or keep your personal information. Such cases may include
            (but are not limited to) court orders, criminal investigations,
            government requests, and regulatory obligations. If you have any
          ...
          <InfoExplanation>
            ...
            need us to maintain the personal information solely for the purpose
            ...
            <br />- Deletion: You may have a right to request that we delete the
            ...
            out for you in response to your request. Please be aware that search
          ...
          <InfoExplanation>
            ...
            contact us using the following details: Patryk Heljasiński
